...
const Tags = (props: {
  ...
  return (
    <div
      ref={ref}
      className={cn(
        " top-0 w-full bg-[rgb(235, 235, 235)] flex justify-around border-b-[1px] border-slate-300 min-h-[2rem]",
    ...
    >
      {segmentProps.switch.map((item: any, index: any) => (
        <div
          key={index}
          className="py-4 text-sm font-bold cursor-pointer flex-1 flex items-center justify-center"
          style={{
